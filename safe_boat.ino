...
// {
    ...
    // String link="http://speedsigns.iot.rw/in.php?sn=SPT001&car_speed=&lat_str=-1.982725&lng_str=30.101233"; 
     String link = "http://192.168.1.89/distressalarm/ins.php?sn=SPT001&emergance="+ String(emergance)+"&speed="+String(speed_str)+"&lat_str="+String(lat_str)+"&lng_str="+String(lng_str)+"&wter_presence="+String(wter_presence)+"&water_level="+String(distance_cm);
